...
- Add staging session timelines.
- Add filtering and issue context links.
- Add automated test coverage for core capture behavior.

## Beta

- Harden performance and storage behavior.
- Improve dashboard usability.
- Add team review workflows.
- Add upgrade and release documentation.
- Validate privacy and security assumptions with real staging use cases.

## 1.0

- Publish stable installation docs.
- Publish release notes and support policy.
- Finalize licensing.
- Ship a stable Strata package and dashboard experience.
